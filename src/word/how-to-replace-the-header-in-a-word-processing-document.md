...
In ooxmlsdk 0.6.1, `MainDocumentPart::header_parts(&document)` traverses header parts. Generated schema types include `Header`, `HeaderReference`, and `SectionProperties`.
