...
This topic discusses the Open XML SDK `DocumentFormat.OpenXml.Spreadsheet.Table` class and how it relates to the Open
...
The following information from the [ISO/IEC 29500](https://www.iso.org/standard/71691.html) specification introduces the `table` (`<table/>`) element.
...
|---------------------------|------------------------------------------------------------------------------------------------------------------------|
|        `<tableColumn/>`        | `DocumentFormat.OpenXml.Spreadsheet.TableColumn`   |
|        `<autoFilter/>`         | `DocumentFormat.OpenXml.Spreadsheet.Table.AutoFilter` |
