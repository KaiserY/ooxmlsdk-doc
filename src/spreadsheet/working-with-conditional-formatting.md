...
This topic discusses the Open XML SDK `DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatting` class and how it
...
|---------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
|          `<cfRule/>`           | `DocumentFormat.OpenXml.Spreadsheet.ConditionalFormattingRule` |
|          `<dataBar/>`          |                   `DocumentFormat.OpenXml.Spreadsheet.DataBar`                   |
|        `<colorScale/>`         |                `DocumentFormat.OpenXml.Spreadsheet.ColorScale`                |
|          `<iconSet/>`          |                   `DocumentFormat.OpenXml.Spreadsheet.IconSet`                   |
