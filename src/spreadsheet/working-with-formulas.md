...
This topic discusses the Open XML SDK `DocumentFormat.OpenXml.Spreadsheet.CellFormula` class and how it relates to the
...
when the worksheet is opened. For more information about the `CellValue` class, see `DocumentFormat.OpenXml.Spreadsheet.CellValue`.
