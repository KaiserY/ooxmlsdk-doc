...
This topic discusses the Open XML SDK `DocumentFormat.OpenXml.Spreadsheet.SharedStringTable` class and how it relates
...
|---------------------------|------------------------------------------------------------------------------------------------------------------------------|
|            `<si/>`             | `DocumentFormat.OpenXml.Spreadsheet.SharedStringItem` |
|             `<t/>`             |             `DocumentFormat.OpenXml.Spreadsheet.Text`             |
